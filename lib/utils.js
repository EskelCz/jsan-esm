...
import pathGetter from './path-getter.js'
import * as jsan from './index.js'

export function getRegexFlags (regex) {
  var flags = '';
...
export function stringifyFunction (fn, customToString) {
...
export function restore (obj, root) {
  var type = obj[0]
